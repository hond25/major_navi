const majorData = {
    ...
    '音楽メディア専攻': {
        ...
        description: '音楽はもちろん、環境音や効果音といった「非楽音」の分野にも力を入れているの音楽はもちろん、環境音や効果音といった「非楽音」の分野にも力を入れている。スタジオでのレコーディングやライブでのPAなど、音楽の現場を「担う」側の技術も積極的に学ぶことができる。が特徴的。音楽を「作る」だけでなく、スタジオでのレコーディングやPA（音響）など、現場を「担う」側の技術も積極的に学ぶことができる。',
